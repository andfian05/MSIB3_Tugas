...
<?php 
     ...
     $obj1 = new Tabel('Febi Febiyanti', '12345', 'Islam', 'Staff','Belum Menikah');
     $obj2 = new Tabel('Andika Alifian', '23451', 'Islam', 'Manager','Belum Menikah');
     $obj3 = new Tabel('Nurul Syahla', '34512', 'Islam', 'Asistant Manager','Belum Menikah');
     $obj4 = new Tabel('Puan Maharani', '45123', 'Khatolik', 'Head Of Division','Menikah');
     $obj5 = new Tabel('Hino Takua', '51234', 'Hindu', 'Staff','Menikah');
    

      ?>

  <h1>Gaji Pegawai || PT.Ibu Anak Honda</h1>
